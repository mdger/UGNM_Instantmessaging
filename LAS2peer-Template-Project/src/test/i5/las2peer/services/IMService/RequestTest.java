...
public class RequestTest extends ServiceTest {
	...
	/**
	 * Test POST Request testAgent schickt eine Contact-Request an testAgent2
	...
	public void testCreateRequest() {
		...
		try {
			...
			ClientResponse result = c.sendRequest("POST", mainPath + "profile/contact/request", "{\"username\":\""
	...
	public void testDeleteRequest() {
		...
		try {
			c.setLogin(getEveID(), evePass);
			ClientResponse result = c.sendRequest("DELETE", mainPath + "profile/contact/request",
					"{\"username\":\"adam\"}", "application/json", "*/*", new Pair[] {});
			assertEquals(200, result.getHttpCode());
